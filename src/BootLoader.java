 ...
 * @see Platform
 * @deprecated 
 * In Eclipse 3.0 the runtime has been refactored such that the <code>BootLoader
 * class is no longer relevant.  Most of the function found on <code>BootLoader is
...
public final class BootLoader {
   ...
   public static boolean CONFIGURATION_DEBUG = false;
    ...
    /**
   * The unique identifier constant (value "<code>org.eclipse.core.boot")
 ...
 private BootLoader() {
   ...
   * if they are being run individually rather than with <code>Platform.run().
      * 
  ...
  *
   * @return the URL indicating where the platform runtime is installed.
    * @deprecated Use <code>Platform.getInstallLocation().getURL()
      */
 ...
 /**
    ...
    * whose path starts with <code>$nl$.
    *
 ...
 /**
        ...
        * files whose path starts with <code>$os$.  OS_UNKNOWN is
  * returned if the operating system cannot be determined.  
     * The value may indicate one of the operating systems known to the platform
      * (as specified in <code>knownOSValues) or a user-defined string if
    ...
    * @see #knownOSValues
     ...
     * The value is a user-defined string if the architecture is 
      ...
      * returned by <code>java.lang.System.getProperty("os.arch").
  * 
  ...
  * Returns a platform configuration object, optionally initialized with previously saved
   ...
   * 
     * @param url location of previously save configuration information. If <code>null
  ...
  * @deprecated This functionality has moved to the Eclipse Update manager plug-in.
      ...
      * whose path starts with <code>$ws$.  null is returned
   * if the window system cannot be determined.
       *
        * @return the string name of the current window system or <code>null
    ...
    * Note that this list is not authoritative; there may be legal values
      ...
      * <code>getOSArch may not be in this list. Also, this list may 
  ...
  public static String[] knownOSArchValues() {
     ...
     * Note that this list is not authoritative; there may be legal values
  * not included in this list. Indeed, the value returned by 
       * <code>getOS may not be in this list. Also, this list may 
      * change over time as Eclipse comes to run on more operating environments.
      * </p>
    * 
  ...
  * @deprecated Replaced by {@link Platform#knownOSValues()}.
  ...
  public static String[] knownOSValues() {
     ...
     * Note that this list is not authoritative; there may be legal values
  * not included in this list. Indeed, the value returned by 
       * <code>getWS may not be in this list. Also, this list may 
      * change over time as Eclipse comes to run on more operating environments.
      * </p>
    * 
 ...
 /**
        * Returns <code>true if the platform is currently running in 
  ...
  *
   * @return <code>true if the platform is running, 
   ...
   * If the given location is <code>null or does not indicate a valid 
    * plug-in path definition file, <code>null is returned.
     *
  ...
  public static URL[] getPluginPath(URL pluginPathLocation) {
     ...
     * Returns whether the given location (typically a directory in the
      ...
      * (for example, so that an active plug-in can save its state).
        *
         * @return <code>true if the location contains the 
         *         saved data for a platform, and <code>false otherwise
     * @deprecated In Eclipse 3.0 this method is no longer supported.
   * The implementation always returns <code>true.
        */
  ...
  * Instantiates and returns an instance of the named application's 
      * runnable entry point.
       * <code>null is returned if the runnable cannot be found.
  *
   * @param applicationName the fully qualified name of an 
       *                 extension installed in the platform's <code>applications 
     *             extension point (i.e., <code>org.eclipse.core.applications).
         * @return a platform runnable
      * @exception Exception if there is a problem instantiating the specified runnable
     * @deprecated In Eclipse 3.0 this method is no longer supported.
   * The implementation always returns <code>null.  See the related but 
     * non-API methods on <code>org.eclipse.core.runtime.adaptor.EclipseStarter
   ...
   * Instantiates and returns an instance of the named class.  The class
       * must implement <code>IPlatformRunnable.
      * If the class implements <code>IExecutableExtension, the created
  ...
  * <code>null is returned if the runnable cannot be found.
      ...
      * @param pluginId the unique identifier of the plug-in containing the given class
       * @param className the fully qualified name of the class to instantiate
        * @param args the initialization arguments passed to the new instance
         * @return a platform runnable, or <code>null if the runnable cannot
    *    be found
        * @exception Exception if there is a problem instantiating the specified runnable
       * @deprecated In Eclipse 3.0 this method is no longer supported.
     * The implementation always returns <code>null.  See the related but 
    ...
    *
     * @param applicationName The fully qualified name of an 
         *           extension installed in the Platform plug-in's <code>applications 
         *         extension-point (i.e., <code>org.eclipse.core.runtime.applications).
  ...
  *          the return value of this method.  
       *@return the list of <code>args which were supplied but not consumed
         *         by this method.  
   ...
   * @return the result, or <code>null if none
      ...
      * The implementation always returns <code>null.  See the related but 
       ...
       * Shuts down the Platform. The Platform must be running. In the process,
         * each active plug-in is told to shutdown via <code>Plugin.shutdown.
         * <p>
      ...
      * On return, the Platform will no longer be running (but could
        * be re-launched with another call to <code>startup). 
    * Any objects handed out by running Platform, including
       * Platform runnables obtained via <code>getRunnable,
  ...
  * Launches the Eclipse Platform. The Platform must not be running.
     ...
     * The location of the started Platform is defined as follows:
      * <ul>
    * <li>If the location argument is specified, that value is used.  
   * <li>If location is null but args 
        *                contains a <code>-data<location> pair, then the given value is used.  
         * <li> If neither is specified, System.getProperty("user.dir") is used.
    * </ul>
         * The plug-in path of the started Platform is defined as follows:
        * <ul>
      * <li>If the pluginPathLocation argument is specified, that value is tried.
         * <li>If pluginPathLocation is null but args 
    *            contains a <code>-plugins <location> pair, then the given value is tried.  
