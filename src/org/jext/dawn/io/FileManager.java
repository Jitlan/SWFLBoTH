...
public class FileManager
{
   ...
   * @param function The Function which is opening the file
   * @param parser The DawnParser which is executing the above function
   */
   ...
   * isLine parameter.
   * @param isLine If true, the NEW_LINE value is added to the line
   * @param ID The file internal ID
   * @param line The line to be written
   * @param function The Function which is opening the file
   * @param parser The DawnParser which is executing the above function
